...
while True:
	...
	#	print latRound
		...
		position = {"geometry": {"type": "Point", "coordinates": [ tracking[2] , tracking[1] ]}, "type": "Feature", "properties":{"alias":str(tracking[0]), "speed": tracking[3], "heading": tracking[4], "tracking_state":tracking_state, "vehicle_state":state, "alarm_state":str(tracking[7]), "license":str(tracking[8])}}
